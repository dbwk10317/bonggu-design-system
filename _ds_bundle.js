...
function useAnchoredPopover({
  ...
  useIsoLayoutEffect(() => {
    ...
    return () => {
      ...
      document.removeEventListener("scroll", place, {
        capture: true
      });
...
function SidebarShell({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "bds-skip",
    href: `#${id}-main`
  }, "본문으로 건너뛰기"), /*#__PURE__*/React.createElement("aside", {
    id: id,
    ref: side,
