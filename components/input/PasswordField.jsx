...
export const PasswordField = forwardRef(
   ...
   */
  function PasswordField({ value, onChange, strength = false, autoComplete = "current-password", ...rest }, ref) {
  const [show, setShow] = useState(false);
  const lv = strength ? passwordStrength(value) : 0;
  return (
    <div className="bds-pw">
      <TextField ref={ref} type={show ? "text" : "password"} value={value} onChange={onChange} autoComplete={autoComplete} mono
