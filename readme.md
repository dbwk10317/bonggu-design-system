...
작성일: 2026-09-09. 상태: 1~4단계 완료. `1.0.0-beta.0`은 GitHub Packages `next` 채널로 발행했고, 2026-09-14에 레지스트리를 npmjs로 옮겨 `1.0.0`을 `latest`로 발행했다(태그 `v1.0.0`, 커밋 `c580e36`). 남은 것은 5단계다.
...
1. Changesets를 도입한다. 소비자 관점의 변경 설명과 버전 영향도를 changeset에 기록한다.
